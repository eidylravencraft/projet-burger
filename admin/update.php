...
$query =
    "SELECT items.*, items.id AS 'items_id', categories.name AS 'categorie' FROM items
JOIN categories
            ...
            <div class="col-md-6">
                ...
                <form class="form" action="updateREQ.php" role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <p><?= $product['image'] ?></p>
                        <!-- $_SERVER['DOCUMENT_ROOT'] en php pour revenir à la racine -->
                        <div class="help-inline"><img src="../images/<?= $product['image'] ?>" alt="" style="width:300px"></div>
                        <label for="image">Sélectionner une nouvelle image:</label>
                        <input type="file" id="image" name="image">
                    </div>
                    <input type="hidden" value="<?= $product['items_id'] ?>" name="id">
                    <br>
